...
export default function SocialLinks() {
  return (
    <div className="px-3 pt-4 lg:px-9 border-t-2 bg-[#9eedff] text-black ">
      <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
        <div className="sm:col-span-2 lg:pl-28 pt-4" >
          <a href="#" className="inline-flex items-center">
            <Image
              ...
              className="h-14 w-14"
            />
            <span className="ml-6   text-2xl font-bold tracking-wide">
              Book Your
              <br />
        ...
        <div className="flex flex-col gap-2 text-sm">
          <p className="text-base font-bold tracking-wide  pb-9">
            GOOGLE RATING
          </p>
          <div className="flex">
            <div className="flex">

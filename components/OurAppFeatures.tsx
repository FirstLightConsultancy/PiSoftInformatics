...
export default function OurAppFeatures() {
  return (
    <main
      className="w-full flex justify-center flex-wrap sm:flex-row-reverse gap-3 p-4 py-16"
      style={{
        backgroundImage:
    ...
    >
      <div className="pl-10 max-w-[640px]">
      ...
      <div className="max-w-lg flex justify-center items-center">
        <iframe
          ...
          className="rounded rounded-xl border border-4 border-black"
        ...
        <span className="absolute -right-1 top-28 border border-4 border-black h-10 rounded-md"></span>
        <span className="absolute -right-1 top-[220px] border border-4 border-black h-24 rounded-md"></span>

        {/* <img src="./dist/static/watch_on_youtube.png" className="h-[600px]" alt=""> */}
      </div>
    </main>
  );
}
